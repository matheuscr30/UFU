 ...
 * @author matheus
 */
public class Inimigo3 implements Observer{
    
    private Observable coordsPersonagem;
    private double coord_x;
    private double coord_y;

    public Inimigo3(Observable coordsPersonagem){
    ...
    public void update(Observable o, Object o1) {
        ...
        System.out.println("Inimigo 3 descobriu a nova localizacao do Personagem"
