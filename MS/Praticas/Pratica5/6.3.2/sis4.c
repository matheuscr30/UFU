 ...
 */
{
  ...
  double a = 0.0, b = 2.0;
  double alpha = cdfGeometric(0.2, a-1);
  double beta = 1.0 - cdfGeometric(0.2, b);
  double u = Uniform(alpha, 1.0 - beta);
  long x = idfGeometric(0.2, u);
  *amount = x;       /* demand amount   */

  //*amount = Geometric(0.2);
  return (time);
}
 ...
 */
{
  ...
  return (t);
   ...
   int main(void)
{
  //printf("Without Truncation\n");
  printf("With Truncation\n");
