...
/* ============== */
{
    ...
    while(min <= 40){
          ...
          while (!feof(fp)) {
            index++;
            if (inventory < min) {             /* place an order          */
      ...
      printf("Setup Cost .......... = %6.2f\n", sum.setup / index * 1000);
      //      fprintf(arq, "%.0f\n", sum.setup / index * 1000);       //valor ref. ao setup = $1000
      //    printf("average holding level .... = %6.2f\n", sum.holding / index);
      printf("Holding Cost .... = %6.2f\n", sum.holding / index * 25);
     // fprintf(arq, "%.0f\n", sum.holding / index * 25); //valor ref. ao holding = $25
       //   printf("average shortage level ... = %6.2f\n", sum.shortage / index);
       printf("Shortage Cost ... = %6.2f\n", sum.shortage / index *700);
      // fprintf(arq, "%.0f\n", sum.shortage / index * 700); //valor ref. ao shortage = $700
       printf("dependent cost ........... = %6.2f\n\n", ((sum.shortage / index * 700) + (sum.setup / index * 1000) + (sum.holding / index * 25)));
     //  fprintf(arq, "%.0f\n", ((sum.shortage / index * 700) + (sum.setup / index * 1000) + (sum.holding / index * 25))); //valor ref. ao shortage = $700
    }
